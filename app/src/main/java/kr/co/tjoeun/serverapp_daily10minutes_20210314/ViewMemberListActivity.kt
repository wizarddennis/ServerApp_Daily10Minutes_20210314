...
import kr.co.tjoeun.serverapp_daily10minutes_20210314.adapters.ProjecMemberAdapter
...
class ViewMemberListActivity : BaseActivity() {
    ...
    lateinit var mMemberAdapter: ProjecMemberAdapter
...
//                이 코드는 비동기로 돌아가는 영역.
//                하단의 어댑터 연결코드가 => 상단이 있는 멤버데이터추가보다, 먼저 완료될 수도 있다.
//                멤버목록이 다 추가되면 => 어댑터 새로고침 시켜주자.
        ...
        mMemberAdapter = ProjecMemberAdapter(mContext, R.layout.member_list_item, mMemberList)
